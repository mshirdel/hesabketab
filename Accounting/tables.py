...
class ItemTable(tables.Table):
    ...
    def render_commands(self, record):
        return format_html(f"<a href='items/{record.id}/update' class='btn btn-info btn-sm' >ویرایش</a>&nbsp<a href='items/{record.id}/delete' class='btn btn-danger btn-sm' >حذف</a>")
